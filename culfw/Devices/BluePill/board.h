...
#if defined BluePillCUNx4 || defined BluePillCUNx4_BL
#define BOARD_NAME          "BluePillCUNx4"
#define BOARD_ID_STR        "BluePillCUNx4"
#define HAS_MULTI_CC        4
#define NUM_SLOWRF          3
#define HAS_WIZNET

#elif defined BluePillCUNx4_W5100 || defined BluePillCUNx4_W5100_BL
#define BOARD_NAME          "BluePillCUNx4"
#define BOARD_ID_STR        "BluePillCUNx4"
#define HAS_MULTI_CC        4
#define NUM_SLOWRF          3
...
#elif defined BluePillCUNx4_W5500 || defined BluePillCUNx4_W5500_BL
#define BOARD_NAME          "BluePillCUNx4"
#define BOARD_ID_STR        "BluePillCUNx4"
#define HAS_MULTI_CC        4
#define NUM_SLOWRF          3
...
#elif defined BluePillCULx4 || defined BluePillCULx4_BL
#define BOARD_NAME          "BluePillCULx4"
#define BOARD_ID_STR        "BluePillCULx4"
#define HAS_MULTI_CC        4
#define NUM_SLOWRF          3
#define USE_HW_AUTODETECT

#elif defined BluePillCUN || defined BluePillCUN_BL
#define BOARD_NAME          "BluePillCUN"
#define BOARD_ID_STR        "BluePillCUN"
#define HAS_WIZNET

#elif defined BluePillCUL || defined BluePillCUL_BL
#define BOARD_NAME          "BluePillCUL"
#define BOARD_ID_STR        "BluePillCUL"
#else
#define MapleCUL
#define BOARD_NAME          "BluePillCUL"
#define BOARD_ID_STR        "BluePillCUL"
...
#define USBD_CONNECT_PORT     GPIOA
#define USBD_CONNECT_PIN      12
